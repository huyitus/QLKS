...
CREATE TABLE QLKS.YEUCAUDP (
    MAYC NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    MAKH NVARCHAR2(10),
    MAPHONG NVARCHAR2(10)
);
select * from qlks.yeucaudp;
...
--TABLE YEUCAUDP
ALTER TABLE QLKS.YEUCAUDP ADD CONSTRAINT FK_YC_KH FOREIGN KEY (MAKH) REFERENCES QLKS.KHACHHANG (MAKH); 
ALTER TABLE QLKS.YEUCAUDP ADD CONSTRAINT FK_YC_P FOREIGN KEY (MAPHONG) REFERENCES QLKS.PHONG (MAPHONG); 
